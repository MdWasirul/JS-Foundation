...
console.log(teaTypes);    //[ 'herbel tea', 'jasmine tea', 'masala chai' ]
...
// citiesVisited[2]="Berlin";   //[ 'Mumbai', 'Sydney', 'Berlin' ]
...
const lastOrder = teaOrders.pop();   //removes last item from array.
...
const hardCopyCities=[...topCities];  //[ 'Berlin', 'Singapore', 'New York' ] -->common way to use hardcopy.
// topCities.pop();
